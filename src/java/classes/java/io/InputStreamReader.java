 ...
 * efficient conversion of bytes to characters, more bytes may be read ahead
 * from the underlying stream than are necessary to satisfy the current read
 * operation.
 *
 * <p>
...
public class InputStreamReader extends Reader {
	 ...
	 *                                         in, String charsetName) throws
	 *                                         UnsupportedEncodingException {
	 *                                         super(in); if (charsetName == null)
	 *                                         throw new
	 *                                         NullPointerException("charsetName");
	 *                                         sd =
	 *                                         StreamDecoder.forInputStreamReader(in,
	 *                                         this, charsetName); }
	 */
	 ...
	 *
	 * @since 1.4
	 * @spec JSR-51 public InputStreamReader(InputStream in, Charset cs) {
	 *       super(in); if (cs == null) throw new NullPointerException("charset");
	 ...
	 *
	 * @since 1.4
	 * @spec JSR-51 public InputStreamReader(InputStream in, CharsetDecoder dec) {
	 *       super(in); if (dec == null) throw new NullPointerException("charset
	 *       decoder"); sd = StreamDecoder.forInputStreamReader(in, this, dec); }
	 */
	 ...
	 * {@link #InputStreamReader(InputStream, String)} constructor then the returned
	 * name, being unique for the encoding, may differ from the name passed to the
	 * constructor. This method will return <code>null</code> if the stream has been
	 * closed.
	 * </p>
	 * 
	 * @return The historical name of this encoding, or <code>null</code> if the
	 *         stream has been closed
	 *
	 * @see java.nio.charset.Charset
	 *
	 * @revised 1.4
	 * @spec JSR-51 public String getEncoding() { return sd.getEncoding(); }
	 */
